...
const ADMISSION_TYPE_OPTIONS: Record<string, string[]> = {
  ...
  "明治学院大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "立教大学": ["自由選抜入試", "アスリート選抜入試", "国際コース選抜入試"],
  "中央大学": ["自己推薦入試", "スポーツ推薦入試", "英語運用能力特別入試"],
  "学習院大学": ["公募制推薦入試", "AO入試"],
  "國學院大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "成城大学": ["AO入試", "自己推薦入試"],
  "成蹊大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "獨協大学": ["AO入試", "自己推薦入試"],
  "武蔵大学": ["AO入試", "自己推薦入試"],
  "武蔵野大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "日本大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試", "指定校推薦"],
  "東洋大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "駒澤大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "専修大学": ["AO入試", "自己推薦入試"],
  "東京都市大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "順天堂大学": ["AO入試", "自己推薦入試"],
  "東京女子大学": ["AO入試", "自己推薦入試"],
  "津田塾大学": ["AO入試", "自己推薦入試"],
  "日本女子大学": ["AO入試", "自己推薦入試"],
  "同志社大学": ["AO入試（フレックス）", "スポーツ推薦入試", "キャンパスアジア特別選抜"],
  "立命館大学": ["AO入試", "スポーツ推薦入試", "指定校推薦"],
  "関西大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "関西学院大学": ["AO入試", "自己推薦入試", "スポーツ推薦入試"],
  "立命館アジア太平洋大学（APU）": ["AO入試", "グローバル入試"],
}
